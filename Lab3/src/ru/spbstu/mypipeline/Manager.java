...
enum dataTypesEnum{BYTE, CHAR, STRING}
...
public class Manager implements Runnable {
    ...
    public Manager(String ConfigName, Log log) {
        ...
        reader = (Reader)init(log, (String) c.valueOf(ReaderParams.READER.toString())[0], (String) c.valueOf(ReaderParams.READER_CONF.toString())[0]);
        writer = (Writer)init(log, (String) c.valueOf(WriterParams.WRITER.toString())[0], (String) c.valueOf(WriterParams.WRITER_CONF.toString())[0]);
        ...
        for (int i = 0; i < c.valueOf(ExecutorParams.EXECUTOR.toString()).length; i++) {
            ...
            executors.add((Executor) init(log, ExecutorName, ExecutorConf));
        }
    }
